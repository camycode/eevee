 ...
 * @param callback 回调函数
 */
function addMarker(x, y, freight, address, callback) {
...
function addAddressMarker(address, freight, callback) {
    ...
    myGeo.getPoint(address, function (point) {
        ...
        if (point) {
            ...
            addMarker(point.lng, point.lat, freight, address, callback);
...
$submit.click(function () {
    ...
    addAddressMarker(address, freight, function (x, y, freight, address) {
...
for (var i = 0; i < orders.length; i++) {
    ...
    addMarker(orders[i].lng, orders[i].lat, orders[i].freight, orders[i].address);
}
