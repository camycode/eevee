...
class ClientController extends Controller
{
    ...
    {
        return $context->response((new Client())->getClient($context->params('id'), $context->params('app_id')));
    }
    ...
    {
        return $context->response((new Client($context->data()))->updateClient($context->params('id'), $context->params('app_id')));
    }

    // 删除Client
    public function deleteClient(Context $context)
    {
        return $context->response((new Client())->deleteClient($context->params('id'), $context->params('app_id')));
    }
