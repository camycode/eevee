...
return [
    ...
    // 资源
    'get@resource' => ['action' => 'ResourceController@getResource'],
    'get@resources' => ['action' => 'ResourceController@getResources'],
    'post@resource' => ['action' => 'ResourceController@postResource'],
    'put@resource' => ['action' => 'ResourceController@putResource'],
    'delete@resource' => ['action' => 'ResourceController@deleteResource'],

    // 权限
    'get@permission' => ['action' => 'PermissionController@getPermission'],
    'get@permissions' => ['action' => 'PermissionController@getPermissions'],
    'post@permission' => ['action' => 'PermissionController@postPermission'],
    'put@permission' => ['action' => 'PermissionController@putPermission'],
    'delete@permission' => ['action' => 'PermissionController@deletePermission'],
